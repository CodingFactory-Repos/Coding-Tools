		...
		>
			<div class="relative p-4 w-full h-auto" :class="`${modalSizeClasses[size]}`">
				...
				<div class="relative rounded-lg shadow bg-light-primary dark:bg-dark-tertiary p-4">
					...
					<button @click="closeModal" type="button" class="absolute right-2 top-2 text-gray-400 bg-transparent hover:bg-light-secondary dark:hover:bg-dark-tertiary rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
