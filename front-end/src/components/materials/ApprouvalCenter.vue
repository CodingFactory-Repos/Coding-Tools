<template>
	...
	>
		...
		<div v-for="res in reservation" :key="res._id">
			<div v-for="history in res.borrowingHistory" :key="history.borrowingDate">
						...
						<a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
							...
							<div class="w-full pl-3">
								<div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400">
									...
									<span class="font-semibold text-gray-900 dark:text-white"></span>: MacBook Pro
									2017
								</div>
								<button
									type="button"
									...
									@click="console.log('Refuser ' + history.borrowingDate + ' ' + res._id)"
								>
									Refuser
								</button>
								<button
...
http.get(`materials/pendingReservation`).then((res) => {
