<template>
	...
	<div>
		...
		<div class="flex justify-between bg-light-tertiary first-line:align-middle font-bold dark:text-white text-[#213547] dark:!bg-dark-highlight font-bold dark:text-[#9ca3af] text-[#213547] rounded-lg text-4xl p-3">
			<span>{{title}}</span>
			<div>
				<span>{{courseTag}}</span>
