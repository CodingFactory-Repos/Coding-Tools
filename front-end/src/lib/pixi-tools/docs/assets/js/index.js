(() => {
	var e = {
					...
					void 0 ===
						(o =
							...
							typeof (t = function () {
									...
									var m = {
										...
										go: function (e, n, t) {
											...
											var r = (e = m.prepareSearch(e))[0],
												a = (t && t.threshold) || (h && h.threshold) || -9007199254740991,
												i = (t && t.limit) || (h && h.limit) || 9007199254740991,
												s = (
													t && void 0 !== t.allowTypo
														? t.allowTypo
														: !h || void 0 === h.allowTypo || h.allowTypo
											...
											if (t && t.keys)
												for (
													var v = t.scoreFn || l, y = t.keys, w = y.length, b = g - 1;
													b >= 0;
													--b
												) {
													for (var k = n[b], x = new Array(w), j = w - 1; j >= 0; --j)
														(T = c(k, (L = y[j])))
															? (d(T) || (T = m.getPrepared(T)), (x[j] = s(e, T, r)))
															: (x[j] = null);
													x.obj = k;
													var I = v(x);
													null !== I &&
													...
													(T = c((k = n[b]), L)) &&
														...
														null !== (B = s(e, T, r)) &&
															(B.score < a ||
																...
																u < i
																	? (p.add(B), ++u)
																	: (++f, B.score > p.peek().score && p.replaceTop(B)))));
											} else
												for (b = g - 1; b >= 0; --b) {
													var T, B;
													(T = n[b]) &&
											...
											var a = !1,
												i = new Promise(function (i, s) {
													...
													var p = (e = m.prepareSearch(e))[0],
														f = u(),
														g = t.length - 1,
														v = (r && r.threshold) || (h && h.threshold) || -9007199254740991,
														y = (r && r.limit) || (h && h.limit) || 9007199254740991,
														w = (
													...
													function x() {
														...
														var u = Date.now();
														if (r && r.keys)
															for (var h = r.scoreFn || l, j = r.keys, I = j.length; g >= 0; --g) {
																for (var L = t[g], T = new Array(I), B = I - 1; B >= 0; --B)
																	(_ = c(L, (S = j[B])))
																		? (d(_) || (_ = m.getPrepared(_)), (T[B] = w(e, _, p)))
																		: (T[B] = null);
																T.obj = L;
																var E = h(T);
																if (
																	...
																	b < y
																		? (f.add(T), ++b)
																		: (++k, E > f.peek().score && f.replaceTop(T)),
																	g % 1e3 == 0 && Date.now() - u >= 10)
																)
																	return void (n ? setImmediate(x) : setTimeout(x));
															}
														else if (r && r.key) {
															for (var S = r.key; g >= 0; --g)
																if (
																	...
																	null !== (M = w(e, _, p)) &&
																		...
																		b < y
																			? (f.add(M), ++b)
																			: (++k, M.score > f.peek().score && f.replaceTop(M)),
																		g % 1e3 == 0 && Date.now() - u >= 10))
																)
																	return void (n ? setImmediate(x) : setTimeout(x));
														} else
														...
														if (0 === b) return i(o);
														for (var C = new Array(b), N = b - 1; N >= 0; --N) C[N] = f.poll();
														(C.total = b + k), i(C);
													}
													n ? setImmediate(x) : x();
												});
										...
										highlight: function (e, n, t) {
											...
											for (
												var r = '', o = 0, a = !1, i = e.target, s = i.length, l = e.indexes, c = 0;
												c < s;
												++c
											) {
												var d = i[c];
										...
										getPrepared: function (e) {
											...
											var n = t.get(e);
											return void 0 !== n || ((n = m.prepare(e)), t.set(e, n)), n;
										},
										getPreparedSearch: function (e) {
											if (e.length > 999) return m.prepareSearch(e);
											var n = r.get(e);
											return void 0 !== n || ((n = m.prepareSearch(e)), r.set(e, n)), n;
										},
										algorithm: function (e, n, t) {
											for (
											...
											null === g &&
												(g = n._nextBeginningIndexes = m.prepareNextBeginningIndexes(n.target));
											...
											if (c !== s)
												for (;;)
													if (c >= s) {
														...
														e[0 === p ? l : p === l ? l + 1 : p === l - 1 ? l - 1 : l] === r[c]
													) {
														if (((i[f++] = c), ++l === o)) {
															h = !0;
															break;
										...
										algorithmNoTypo: function (e, n, t) {
											for (
												var r = n._targetLowerCodes,
													o = e.length,
													s = r.length,
											...
											if (
												(null === h &&
													(h = n._nextBeginningIndexes = m.prepareNextBeginningIndexes(n.target)),
												(c = 0 === a[0] ? 0 : h[a[0] - 1]) !== s)
											)
												for (;;)
													if (c >= s) {
										...
										prepareLowerCodes: function (e) {
											for (var n = e.length, t = [], r = e.toLowerCase(), o = 0; o < n; ++o)
												t[o] = r.charCodeAt(o);
											return t;
										},
										prepareBeginningIndexes: function (e) {
											for (var n = e.length, t = [], r = 0, o = !1, a = !1, i = 0; i < n; ++i) {
												var s = e.charCodeAt(i),
													l = s >= 65 && s <= 90,
													c = l || (s >= 97 && s <= 122) || (s >= 48 && s <= 57),
													d = (l && !o) || !a || !c;
												(o = l), (a = c), d && (t[r++] = i);
											}
											return t;
										...
										prepareNextBeginningIndexes: function (e) {
											for (
												...
												o > i ? (r[i] = o) : ((o = t[++a]), (r[i] = void 0 === o ? n : o));
											return r;
										},
										cleanup: s,
										new: e,
								...
								function l(e) {
									for (var n = -9007199254740991, t = e.length - 1; t >= 0; --t) {
										var r = e[t];
										if (null !== r) {
											var o = r.score;
											o > n && (n = o);
			...
			228: function (e, n, t) {
				...
				(0, t(343).initTheme)(),
					window.addEventListener('load', function () {
						var e,
							...
							u = function (e) {
								...
								!1 === r
									...
									: !0 === r && (n.classList.add('open'), t.classList.add('open')),
									(e.onclick = function () {
						...
						try {
							for (
								var p = r(document.getElementsByClassName('collapsible-trigger')), h = p.next();
								!h.done;
								h = p.next()
							) {
								var m = u(h.value);
						...
						try {
							for (
								var g = r(document.getElementsByClassName('c-tooltip')), v = g.next();
								!v.done;
								v = g.next()
							) {
								f(v.value);
									...
									o = function (e) {
										...
										o.onclick = function () {
											if (!o.classList.contains('selected')) {
												o.classList.add('selected'), (t[e].style.display = 'block');
												for (var a = 0; a < r; a++)
													a !== e &&
														(n[a].classList.remove('selected'), (t[a].style.display = 'none'));
											}
										};
									},
									a = 0;
						...
						try {
							for (
								var w = r(document.getElementsByClassName('tab-code')), b = w.next();
								!b.done;
								b = w.next()
							) {
								y(b.value);
							...
							(k.onchange = function (e) {
								...
								window.ab && (window.depth += '../'),
									'main' === n.value
										...
										: (location.href = window.depth + 'b.' + n.value + '/index.html');
							});
						var x = document.getElementById('content-main'),
							j = document.getElementById('search-menu'),
							I = new URLSearchParams(window.location.search);
						I.has('search') ? j.classList.remove('d-none') : x.classList.remove('d-none'),
						...
						T.addEventListener('scroll', function () {
							...
							(L.onclick = function () {
								return T.scroll({ top: 0, behavior: 'smooth' });
							}),
							(0, a.initSidebar)(x);
					});
			},
			734: function (e, n, t) {
					...
					s =
						...
						function (e, n) {
							...
							var r,
								...
								i = [];
							try {
								for (; (void 0 === n || n-- > 0) && !(r = a.next()).done; ) i.push(r.value);
							} catch (e) {
								o = { error: e };
							} finally {
								try {
				...
				Object.defineProperty(n, '__esModule', { value: !0 }), (n.initSearch = void 0);
				var c = t(360);
				function d(e, n) {
					return (e & n) === n;
				}
							...
							return h
								? ((p = e),
										...
										return h
											? e.includes('.')
												? (0, c.go)(
														...
														{ key: 'name', allowTypo: !0, limit: 100, threshold: -6e3 },
												  ).map(function (e) {
														return (
												...
												: (0, c.go)(e, n, {
														...
														.concat()
														.sort(function (e, n) {
															return e.score < -5e3 || n.score > -1e3 ? 0 : e.obj.type - n.obj.type;
														})
														.map(function (e) {
															return (
										...
										(function (e, n) {
											...
											try {
												for (var a = i(n), s = a.next(); !s.done; s = a.next()) {
													var l = s.value;
													if (
														(!e.thisModuleOnly.checked || !window.lm || l.path[0] === window.lm) &&
														...
														(e.properties.checked || (6 !== l.type && 7 !== l.type))
													) {
														if (8 === l.type) {
														...
														(e.enumMembers.checked || 9 !== l.type) && o.push(l);
													}
												}
											} catch (e) {
												t = { error: e };
								  ...
								  (function (e) {
										...
										if (!e.length)
											return void (n.innerHTML = '<h1 class="text-center">No results!</h1>');
										if (1 === e.length)
											n.innerHTML =
												'\n         <div>\n         ' +
												e
					...
					switch (e.type) {
						case 0:
							t =
								...
								'\n            ' +
								(n.length ? '<p class="docblock secondary">In ' + n.join('/') + '</p>' : '') +
								'\n            </div>';
							break;
						case 1:
							t =
														...
														s(
															o[1].map(function (e) {
																...
																return (
																	...
																	{ name: e[0], path: t, type: 0, comment: e[4] }
																);
															}),
														),
														!1,
																...
																return (
																	h.push.apply(
																		...
																		l(
																			...
																			s(
																				e[1].map(function (n) {
																					return { name: n, path: t, obj: e[0], type: 7 };
																				}),
																			),
																			!1,
																		),
																	),
																	{ name: e[0], path: t, type: 1, comment: e[3] }
																);
															}),
														),
														!1,
																...
																return (
																	h.push.apply(
																		...
																		l(
																			...
																			s(
																				e[1].map(function (n) {
																					return { name: n, path: t, obj: e[0], type: 9 };
																				}),
																			),
																			!1,
																		),
																	),
																	{ name: e[0], path: t, type: 2, comment: e[3] }
																);
															}),
														),
														!1,
										  ...
										  (window.onpopstate = function (e) {
												e.state && e.state.search
													? (n.classList.add('d-none'),
													  ...
													  m(e.state.search, i))
													: (n.classList.remove('d-none'), t.classList.add('d-none'));
										  }),
										  e.has('search') ? ((s = e.get('search')), (r.value = s), [4, g()]) : [3, 2])
										: [3, 5];
								case 1:
													...
													case 0:
														return (
															...
															(o = r.value.trim()).length
																? (history.pushState({ search: o }, '', '?search=' + o),
																  [4, m(o, i)])
																: (t.classList.add('d-none'), n.classList.remove('d-none'), [2])
														);
													case 1:
														return (
															a.sent(), n.classList.add('d-none'), t.classList.remove('d-none'), [2]
														);
												}
											});
										});
			...
			304: (e, n) => {
				'use strict';
				Object.defineProperty(n, '__esModule', { value: !0 }), (n.initSidebar = void 0);
				var t = '';
				n.initSidebar = function (e) {
					...
					if (n) {
						...
						n.addEventListener('click', function () {
							...
							e.addEventListener('click', function (e) {
								window.innerWidth > 680 || (r.classList.remove('d-block'), (n.innerHTML = t));
							});
					}
				};
			},
			343: (e, n) => {
				'use strict';
				Object.defineProperty(n, '__esModule', { value: !0 }), (n.initTheme = void 0);
				var t,
					r = {
						dark: {
				...
				function o(e, n, o, a) {
					(document.documentElement.dataset.theme = e),
						...
						a &&
							('light' === e
								? (o && (o.innerHTML = r.dark.icon), (a.href = r.light.highlightTheme))
								: (o && (o.innerHTML = r.light.icon), (a.href = r.dark.highlightTheme)));
				}
				function a() {
				...
				n.initTheme = function () {
					...
					e || (e = window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light'),
						o(e, !1),
						window.addEventListener('load', function () {
