...
// import { StaticGraphics } from '../../pixi-tools/class/staticGraphics';

// export default class LibraryTextInput extends StaticGraphics {
// 	constructor(styles) {
// 		super();
...
// 		if (styles.box)
// 			this._box_generator =
// 				typeof styles.box === 'function' ? styles.box : new DefaultBoxGenerator(styles.box);
