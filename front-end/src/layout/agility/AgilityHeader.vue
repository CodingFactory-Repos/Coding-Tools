<template>
	<div class="fixed py-3 px-3 lg:px-5 lg:pl-3 w-full shadow-md z-40 bg-white  dark:bg-gray-800">
		<div class="flex justify-between items-center">
			...
			<div class="flex items-center gap-1">
				...
				<div class="flex items-center">
					...
					<div ref="profile" class="hidden absolute right-0 top-14 z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" style="transform: translateX(-10%);" id="dropdown-2" data-popper-placement="bottom">
