...
export class TextInput extends PIXI.Container {
  ...
  private GenerateValueDisplay(): string {
    ...
    let style = new PIXI.TextStyle(this.options.style as any)
 ...
 */
  ...
  */
  private DrawText() {
    ...
    this.textComponent.style = option.style as any;
  }
 ...
 */
  ...
  calculateValueMetrics(): PIXI.TextMetrics {
    return PIXI.TextMetrics.measureText(this.textComponent.text, this.textComponent.style as any, false)
  }
  ...
  private calculateCursorLocation(): { x: number, y: number } {
    ...
    let x = PIXI.TextMetrics.measureText(position.afterCursorLine, this.textComponent.style as any, false).width
