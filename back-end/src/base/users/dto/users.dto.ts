import { STRICT_API_URL, STRICT_GITHUB_URL, STRICT_LINKEDIN_URL, STRICT_URL } from '@/common/constants/global';
...
import { IsArray, IsBoolean, IsNotEmpty, IsObject, IsOptional, IsString, Length, Matches, Validate, ValidateNested } from 'class-validator';
