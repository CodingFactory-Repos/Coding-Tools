...
import {
	USER_GITHUB_PROJECTION,
	USER_GROUPNAME_PROJECTION,
	USER_PROFILE_LIST_PROJECTION,
	USER_RELATED_PROFILE,
} from '@/base/users/utils/users.projection';
...
export class UsersService {
	...
	private readonly githubStatLinkTemplate =
		'https://github-readme-stats-sigma-five.vercel.app/api?username=$USERNAME$&theme=jolly&hide_border=false&include_all_commits=true&count_private=true';
	private readonly githubLanguagesLinkTemplate =
		'https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=$USERNAME$&theme=jolly&hide_border=false&include_all_commits=true&count_private=true&layout=compact';
	...
	async getUserProfileList(userId: ObjectId) {
		const user = await this.usersRepository.findOne({ _id: userId }, USER_GROUPNAME_PROJECTION);
